...
$pageTitle = 'Kelola Praktikum Rangkaian Listrik';
$current_page = 'praktikum-rangkaian';
...
<main class="admin-content">
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold text-dark mb-1">Kelola Praktikum Rangkaian Listrik</h2>
...
function loadModules() {
    ...
    fetch(BASE_URL + '/php-native/api/praktikum/rangkaian-listrik/modules.php')
        .then(res => res.json())
        .then(data => {
...
function loadRegistration() {
    ...
    fetch(BASE_URL + '/php-native/api/praktikum/rangkaian-listrik/registration.php')
        .then(res => res.json())
        .then(data => {
            if (data.data && data.data.length > 0) {
...
function loadSoftware() {
    ...
    fetch(BASE_URL + '/php-native/api/praktikum/rangkaian-listrik/software.php')
        .then(res => res.json())
        .then(data => {
            if (data.data && data.data.length > 0) {
                container.innerHTML = `
...
function deleteModule(id) {
    if (confirm('Yakin ingin menghapus modul ini?')) {
        fetch(BASE_URL + '/php-native/api/praktikum/rangkaian-listrik/modules.php?id=' + id, {
            method: 'DELETE'
        })
        .then(res => res.json())
        .then(data => {
...
function deleteSoftware(id) {
    if (confirm('Yakin ingin menghapus software ini?')) {
        fetch(BASE_URL + '/php-native/api/praktikum/rangkaian-listrik/software.php?id=' + id, {
            method: 'DELETE'
        })
        .then(res => res.json())
        .then(data => {
