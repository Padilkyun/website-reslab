...
function loadModules() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/rangkaian-listrik/modules.php')
        .then(res => res.json())
        .then(data => {
...
function loadRegistration() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/rangkaian-listrik/registration.php')
        .then(res => res.json())
        .then(data => {
            ...
            if (data.data && data.data.length > 0) {
                ...
                container.innerHTML = `
                    <div class="text-center">
                        <p class="text-white-50 mb-4">Silakan klik tombol di bawah untuk mendaftar praktikum Rangkaian Listrik</p>
...
function loadSoftware() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/rangkaian-listrik/software.php')
        .then(res => res.json())
        .then(data => {
