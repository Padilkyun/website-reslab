...
$pageTitle = 'Praktikum Sistem Tertanam';
...
<main class="py-5" style="min-height: 100vh; background: rgba(0,0,0,0.3);">
    <div class="container py-5">
        ...
        <div class="text-center mb-5">
            <h1 class="display-4 fw-bold text-white mb-3">Praktikum Sistem Tertanam</h1>
            <p class="lead text-white-50">Embedded System dan IoT</p>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="glassmorphism-card">
                            <h3 class="text-white mb-4">
                                <i class="bi bi-calendar-check me-2"></i> Link Pendaftaran Praktikum Sistem Tertanam
                            </h3>
...
function loadModules() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/sistem-tertanam/modules.php')
        .then(res => res.json())
        .then(data => {
...
function loadRegistration() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/sistem-tertanam/registration.php')
        .then(res => res.json())
        .then(data => {
            ...
            if (data.data && data.data.length > 0) {
                ...
                container.innerHTML = `
                    <div class="text-center">
                        <p class="text-white-50 mb-4">Silakan klik tombol di bawah untuk mendaftar praktikum Sistem Tertanam</p>
...
function loadSoftware() {
    fetch('<?php echo BASE_URL; ?>/php-native/api/praktikum/sistem-tertanam/software.php')
        .then(res => res.json())
        .then(data => {
